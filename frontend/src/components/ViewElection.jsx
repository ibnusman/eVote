...
export const ViewElection = () => {
  ...
  const searchElection = (e) => {
   const sValue = e.target.value;
    ...
    const seElec = allElections.filter((elec)=> elec.position.toString().toLowerCase().includes(sValue.toLowerCase()))
     setElections(seElec);
  ...
  return (
    <div>
      ...
      {/* Sorting Dropdown */}
   <label htmlFor="search" className="block text-sm font-medium text-gray-600 mb-1">Search by Position</label>
<input
  type="text"
  name="search"
  id="search"
